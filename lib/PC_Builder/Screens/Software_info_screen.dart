...
class SoftwareInfoScreen extends StatefulWidget {
  ...
  @override
  _SoftwareInfoScreen createState() => _SoftwareInfoScreen();
}

class _SoftwareInfoScreen extends State<SoftwareInfoScreen>
  ...
  Widget build(BuildContext context) {
    final softwareid = ModalRoute.of(context)!.settings.arguments as String;
    final softwareitem = Provider.of<software>(context).findbyid(softwareid);
  ...
  Widget getTimeBoxUI(String text1, String txt2) {
    return Padding(
      ...
      child: Container(
        ...
        child: Padding(
          padding: const EdgeInsets.only(
              left: 13.0, right: 13.0, top: 12.0, bottom: 12.0),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            crossAxisAlignment: CrossAxisAlignment.center,
            children: <Widget>[
